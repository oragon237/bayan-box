...
<head>
    <meta charset="utf-8">
    <title>BayanBox Referral — {{ $hub->name }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .brand { font-size: 44px; font-weight: 900; color: #16a34a; letter-spacing: -1px; }
        .brand span { color: #ea580c; }
        .tagline { font-size: 16px; color: #6b7280; margin-top: 4px; }
        .hub-card { margin-top: 24px; border: 3px solid #16a34a; border-radius: 16px; padding: 24px; }
...
<body>
    <div class="poster">
        <div class="brand">Bayan<span>Box</span></div>
        <div class="tagline">Sari-Sari Store Parcel Hub</div>
        ...
        <div class="steps">
            ...
            <div class="step"><b>2. Register</b>Create your free BayanBox account</div>
            <div class="step"><b>3. Earn</b>Every parcel you receive supports this store</div>
        </div>

        <div class="footer">BayanBox · BodegaBarangay · Referral Code: {{ $hub->referral_code }}</div>
    </div>
</body>
</html>
